    ...
    return (
        <article
            ...
            className={classNames(
                ...
                'sb-component-block',
                'sb-component-item',
                props.enableHover ? (props.enableHover === 'scale' ? 'sb-component-item-hover-scale' : 'sb-component-item-hover') : null,
                styles.self?.padding,
                styles.self?.borderColor,
                styles.self?.borderStyle ? mapStyles({ borderStyle: styles.self?.borderStyle }) : 'border-none',
                styles.self?.borderRadius ? mapStyles({ borderRadius: styles.self?.borderRadius }) : null,
                styles.self?.textAlign ? mapStyles({ textAlign: styles.self?.textAlign }) : null,
                styles.self?.boxShadow ? mapStyles({ boxShadow: styles.self?.boxShadow }) : 'shadow-none'
            )}
            style={{
