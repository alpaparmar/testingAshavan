...
export const ConfigModel: Model = {
    ...
    fields: [
        ...
        },
        {
            ...
            description: 'Suffix to append to the title tag of all pages, except in pages where this behavior is disabled (e.g. typically the home page should have the site name as a prefix)',
            default: null,
            group: 'seo'
        },
        {
